		...
		<aside class="col-sm-4">
			<div class="card">
				<article class="card-body">
					<a href="/sportsbetting-application-mvc/register"
						class="float-right btn btn-outline-primary">Sign up</a>
					<h4 class="card-title mb-4 mt-1">Sign in</h4>
					<form action="<spring:url value="/login"/>" method="post" class="col-md-8 col-md-offset-2">
						<div class="form-group">
							<label>Your email</label> <input name="username"
